...
class PaymentController extends Controller
{
    ...
    public function StripeCharge(Request $request)
    {
		...
		\Stripe\Stripe::setApiKey('sk_test_N3kMiT1PnR2GSYMDw3DFbKdF00hKwtvHN0');
		...
		$charge = \Stripe\Charge::create([
  			'amount' => $total*100,
  			'currency' => 'usd',
  			'description' => 'Imam Hossain details',
  			'source' => $token,
    	...
    	$data['payment_amount']=$charge->amount/100;
    	$data['blnc_transection']=$charge->blnc_transection;
    	...
    	$shipping['ship_eddress']=$request->ship_eddress;
