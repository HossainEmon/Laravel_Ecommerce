...
@endphp
    ...
    <div class="sl-mainpanel">
      ...
      <div class="sl-pagebody">
          ...
          <h6 class="card-body-title">Edit BlogPost Add</h6>
          <p class="mg-b-20 mg-sm-b-30">Edit BlogPost add form</p>
            ...
            <div class="row mg-b-25">
              ...
              <div class="col-lg-4">
                <div class="form-group mg-b-10-force">
                  ...
                  <select class="form-control select2" data-placeholder="Choose Category" name="category_id" value="{{ $post->category_id }}">
              ...
              <div class="col-lg-4">
                ...
                <label class="custom-file">
                <img src="{{ URL::to($post->post_image)}}" style="width: 140px; height: 80px;" id="one" >
