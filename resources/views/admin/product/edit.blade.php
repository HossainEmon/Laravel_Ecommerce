...
<div class="sl-mainpanel">
  ...
  <div class="sl-pagebody">
    <div class="card pd-20 pd-sm-40">
          <p class="mg-b-20 mg-sm-b-30">Edit Product</p>
              ...
              <div class="col-lg-4">
                <div class="form-group mg-b-10-force">
                  ...
                  <select class="form-control select2" data-placeholder="Choose country" name="brand_id">
                    ...
                    @foreach($brand as $br)
                    <option value="{{ $br->id }}"><?php if ($product->brand_id == $br->id) { echo "selected";} ?>{{ $br->brand_name }}</option>
                    @endforeach
                  </select>
                </div>
              </div><!-- col-4 -->
      ...
      <div class="sl-pagebody">
          <div class="card pd-20 pd-sm-40">
            <h6 class="card-body-title">Update Product With Photeo</h6>
             ...
             <div class="row">
              ...
              <lebel>Image Two<span class="tx-danger">*</span></lebel><br>
                <label class="custom-file">
                <input type="file" id="file" class="custom-file-input" name="image_two" onchange="readURL1(this);"  accept="image"><input type="hidden" name="old_two" value="{{ $product->image_two }}">
                <span class="custom-file-control"></span>
                <img src="#" id="tow" >
               </label>
            </div>
