                                ...
                                @else
                                 <!-- <div><a href="{{ route('home')}}">Profile</a></div> -->
                                  <ul class="standard_dropdown top_bar_dropdown">
                                    <li>
                                        <a href="{{ route('home')}}"> <div class="user_icon"><img src="{{asset('public/frontend/images/user.svg')}}" alt=""></div><i class="fas fa-chevron-down"></i>Profile</a>
                                        <ul>
                            ...
                            <div class="cart">
                                <div class="cart_container d-flex flex-row align-items-center justify-content-end">
                                    <div class="cart_icon">
                                        ...
                                        <div class="cart_count"><span>1{{ Cart::count()}}</span></div>
                                    </div>
